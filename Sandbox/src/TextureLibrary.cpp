...
void TextureLibrary::AddTexture(Hazel::Ref<Hazel::D3D12Texture2D> texture)
{
...
Hazel::Ref<Hazel::D3D12Texture2D> TextureLibrary::GetTexture(std::wstring& key)
{
    Hazel::Ref<Hazel::D3D12Texture2D> ret = nullptr;
