...
namespace Roses {
	...
	D3D12_INPUT_ELEMENT_DESC D3D12Renderer::s_InputLayout[] = {
			{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(Roses::Vertex, Position), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
			{ "NORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(Roses::Vertex, Normal), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
			{ "TANGENT", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(Roses::Vertex, Tangent), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
			{ "BINORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(Roses::Vertex, Binormal), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
			{ "UV", 0, DXGI_FORMAT_R32G32_FLOAT, 0, offsetof(Roses::Vertex, UV), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
	};
	...
	static Roses::Scene s_DefaultScene(0.8f);
	...
	void D3D12Renderer::Init()
	{
		...
		D3D12Renderer::g_ShaderLibrary = new Roses::ShaderLibrary(D3D12Renderer::FrameLatency);
		D3D12Renderer::g_TextureLibrary = new Roses::TextureLibrary("");
		D3D12Renderer::TilePool = new Roses::D3D12TilePool();
...
#pragma region Engine Shaders
		// Tone mapping
		{
			...
			auto shader = Roses::CreateRef<Roses::D3D12Shader>("assets/shaders/ToneMap.hlsl", pipelineStateStream);
		...
		// Skybox
		{
			...
			auto shader = Roses::CreateRef<Roses::D3D12Shader>("assets/shaders/skybox.hlsl", pipelineStateStream);
			HZ_CORE_ASSERT(shader, "Shader was null");
			D3D12Renderer::g_ShaderLibrary->Add(shader);
		}
...
#pragma endregion
	...
	void D3D12Renderer::ClearVirtualMaps()
	{
		...
		for (auto obj : s_DecoupledOpaqueObjects)
		{
			...
			auto dispatch_count = Roses::D3D12::RoundToMultiple(dims.x * dims.y, 64);
