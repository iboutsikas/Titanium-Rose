...
#define HZ_PROFILE 0
	...
	#define HZ_PROFILE_BEGIN_SESSION(name, filepath) ::Roses::Instrumentor::Get().BeginSession(name, filepath)
	#define HZ_PROFILE_END_SESSION() ::Roses::Instrumentor::Get().EndSession()
	#define HZ_PROFILE_SCOPE(name) ::Roses::InstrumentationTimer timer##__LINE__(name);
