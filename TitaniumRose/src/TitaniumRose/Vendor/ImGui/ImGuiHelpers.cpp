...
namespace ImGui
{
    std::map<Roses::ComponentID, ImGuiRenderingFn> s_RenderingFnMap;
}


static std::tuple<glm::vec3, glm::quat, glm::vec3> DecomposeTransform(Roses::HTransform& transform)
{
...
void ImGui::TransformControl(Roses::HTransform& transform)
{
...
void ImGui::MaterialControl(Roses::Ref<Roses::HMaterial> material)
{
    int oldColumns = ImGui::GetColumnsCount();
    ImGui::Columns(2);
    // ------ Albedo ------
...
void ImGui::MeshSelectControl(Roses::Ref<Roses::HGameObject> target, std::vector<Roses::Ref<Roses::HGameObject>>& models)
{
    Roses::Ref<Roses::HMesh> selectedMesh = target->Mesh;
...
void ImGui::DecoupledTextureControl(Roses::DecoupledTextureComponent& component)
{
    static bool showingTexture = false;
    static Roses::HeapAllocationDescription previewAllocation = Roses::D3D12Renderer::s_ResourceDescriptorHeap->Allocate(1);;
    ...
    sizeInKiB = static_cast<float>(sizeInBytes) * factor;
    ...
    if (showingTexture)
    {
        ...
        Roses::D3D12Renderer::CreateSRV(std::static_pointer_cast<Roses::Texture>(component.VirtualTexture), previewAllocation, selectedMip);
...
void ImGui::EntityPanel(Roses::Ref<Roses::HGameObject> target)
{
...
void ImGui::LightComponentPanel(Roses::Ref<Roses::Component> component)
{
    if (ImGui::CollapsingHeader("Light Component", ImGuiTreeNodeFlags_DefaultOpen))
    {
        Roses::Ref<Roses::LightComponent> light = std::static_pointer_cast<Roses::LightComponent>(component);
